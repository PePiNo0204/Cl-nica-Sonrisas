...
<body>
    ...
    <nav class="sidebar">
        ...
        <div class="menu">
            <ul class="menu-links">
                <li class="nav-link">
                    <a href="dashboard-doctor.php" target="content-area">
                ...
                <li class="nav-link">
                    <a href="misCitas.php" target="content-area">
                        ...
                        <span class="text">Mis Citas</span>
				                ...
				                <li class="nav-link">
                    <a href="CitasAnteriores.php" target="content-area">
                        <i class='bx bx-calendar'></i>
                        <span class="text">Mis Citas Anteriores</span>
                    </a>
                </li>
                <li class="nav-link">
    ...
    <main class="main-content">
        <iframe id="content-area" name="content-area" src="dashboard-doctor.php" frameborder="0" style="width: 100%; height: calc(100vh - 60px);"></iframe>
    </main>
